...
### **Shortcut to Remember Semantic Tags — `H DAMN STAFFF`**

A simple mnemonic to remember the commonly used semantic HTML tags is:

**H DAMN STAFFF**

Each letter represents a semantic tag:
...
So, whenever you need to recall the common semantic tags, remember **“H DAMN STAFFF”**:

`Header → Details → Aside → Main → Nav → Section → Time → Article → Figure → Figcaption → Footer`
